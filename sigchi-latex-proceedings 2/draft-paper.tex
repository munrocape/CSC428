...
\begin{figure}
 ...
 \caption{Left: the non-stacked card multitasking interface of Android 4.4 KitKat. Right: the stacked card interface of Android 5.0 Lollipop}
\end{figure}
...
Given that this was a within-subjects test where we had 1 independent variable, a one-way with one within-subjects factor ANOVA test was carried out.
The mean task completion times was 2.37 seconds for KitKat (non-stacked).  This was 6.7\% slower than the mean of Lollipop (stacked) which was 2.22 seconds. The difference was not statistically significant
...
The mean error rate for was 2.37 total errors for Kitkat and 1.56 total errors per participant for Lollipop. However, as there was substantial variation in the observations across participants, the difference was not statistically significant as revealed by the analysis of variance. Once again, a one-way with one within-subjects factor ANOVA test was carried out
\begin{center}
$(F_{1, 15} = 2.19, ns )$
\end{center}

The exit survey questions relating to the participant’s perceived accuracy and speed were converted to an ordinal scale between 1 and 5. Participants believed they were slightly faster on Lollipop (3.92 average response versus 3.76). Participants perceived they were more accurate on Kitkat (4.38 average response versus 4.07).
...
\section{Appendix C: Consent Form}
I hereby consent to participate in the research study conducted by Ajit Pawar, Colin White, Ishan Thukral, Kyra Assaad, and Zach Munro-Cape as part of the Fall 2015 semester project for CSC428, Human-Computer Interaction, offered by the Department of Computer Science at the University of Toronto.

I agree to participate in this study whose purpose is to evaluate the accuracy and speed of stacked/unstacked smartphone multitasking interfaces.

I understand that:
\begin{itemize}
\item The study uses direct observation.
\item There are no significant risks incurred by participating in this experiment.
\item I will receive no compensation of my participation.
\item I am free to withdraw at any time during the study without the need to give any explanation or reason and without any penalty.
\item All material and results will be kept confidential, and, in particular, that my name and any identifying or identified information will not be associated with the data.
\item I can contact the course lecturer, Oliver St. Cyr (stcyr@mie.utoronto.ca), with any questions or concerns.
\end{itemize}
...
\section{Appendix D: Entry Survey}
...
Have you used the Android operating system before? (choose one)\\
* Yes\\
* No

Do you own an Android phone? (choose one)\\
* Yes\\
* No

What version of Android are you most comfortable with? (choose one)\\
* KitKat\\
* Lollipop\\
* Marshmallow\\
* I’m not sure\\
...
What model of phone do you have? (write below)\\

\section{Appendix E: Exit Survey}
With what speed did you perceive you were able to switch between applications?\\
KitKat (Non-stacked)\\
* Sluggish\\
* Slow\\
* Average\\
...
With what accuracy did you perceive you were able to switch between applications?\\
KitKat (Non-stacked)\\
* Terrible accuracy\\
* Not very accurate\\
* Average\\
...
Do you have a preference on using either OS for its multitasking interface?\\
* KitKat (Non-stacked)\\
* Lollipop (Stacked)\\
* No preference\\
